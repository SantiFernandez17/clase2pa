...
object euforica {	
	...
	method energiaQueGastariaAlVolar(unosKilometros) {// energia que gasta al volar se delega a sus distintos estados de animo
...
object debil {
	...
	method energiaQueGastariaAlVolar(unosKilometros) { // energia que gasta al volar se delega a sus distintos estados de animo
		return unosKilometros / 8 + 50 // si la golondrina esta debil le costará más volar
	}
}
...
object normal {
	...
	method energiaQueGastariaAlVolar(unosKilometros) {// energia que gasta al volar se delega a sus distintos estados de animo
		return unosKilometros / 8 + 10 // si esta normal va a gastar lo que siempre gastaba al volar
	}
}
